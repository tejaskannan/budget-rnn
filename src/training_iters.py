"""
This script approximates the number of training iterations for each model.
"""
import re
import os.path
import math
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input-folder', type=str, required=True, help='Folder containing the RNN models (of the same type) to evaluate.')
    parser.add_argument('--dataset-folder', type=str, required=True, help='Folder containing the dataset used for training and evaluation.')
