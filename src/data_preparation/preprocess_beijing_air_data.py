...
def convert_row(record: List[str]) -> Dict[str, Any]:
    ...
    return dict(date=date.isoformat(),
                ...
                dew_point=try_convert_to_float(record[6], None),
                temp=try_convert_to_float(record[7], None),
                pressure=try_convert_to_float(record[8], None),
                wind_speed=try_convert_to_float(record[10], None),
                snow=try_convert_to_float(record[11], None),
                rain=try_convert_to_float(record[12], None))
