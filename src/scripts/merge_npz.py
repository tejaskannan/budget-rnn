...
def merge_npz_files(input_folders: List[str], output_folder: str, file_prefix: str, chunk_size: int, start_index: int):
    """
    ...
    for input_folder in input_folders:
        files = [os.path.join(input_folder, name) for name in os.listdir(input_folder) if name.endswith('.npz')]
...
if __name__ == '__main__':
    ...
    merge_npz_files(args.input_folders, args.output_folder, args.file_prefix, args.chunk_size, args.start_index)
