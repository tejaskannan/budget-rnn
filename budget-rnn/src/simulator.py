...
if __name__ == '__main__':
    ...
    parser.add_argument('--adaptive-model-paths', type=str, nargs='+', required=True, help='Paths to adaptive models.')
    parser.add_argument('--baseline-model-path', type=str, required=True, help='Path to the standard RNN.')
    parser.add_argument('--skip-model-folder', type=str, help='Path to the Skip RNN folder.')
    parser.add_argument('--phased-model-folder', type=str, help='Path to the Phased RNN folder.')
    parser.add_argument('--dataset-folder', type=str, required=True, help='Path to the dataset folder.')
    parser.add_argument('--budget-start', type=float, required=True, help='Smallest budget to execute.')
    parser.add_argument('--budget-end', type=float, required=True, help='Largest budget to execute.')
    parser.add_argument('--budget-step', type=float, required=True, help='Step between consecutive budgets.')
    parser.add_argument('--output-folder', type=str, required=True, help='Path to store output results.')
    parser.add_argument('--noise-params', type=str, nargs='+', required=True, help='Noise parameter files.')
    parser.add_argument('--power-system-type', type=str, choices=['bluetooth', 'temp'], default='temp', help='Simulated sensor type.')
    parser.add_argument('--skip-plotting', action='store_true', help='Whether to skip plotting the time series results.')
    parser.add_argument('--save-plots', action='store_true', help='Whether to save the time series plots.')
