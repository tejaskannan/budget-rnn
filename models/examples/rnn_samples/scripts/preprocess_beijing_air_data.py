...
def convert_row(record: List[str]) -> Dict[str, Any]:
    ...
    return dict(date=date.isoformat(),
                ...
                dew_point=try_convert_to_float(record[6], 0.0),
                temp=try_convert_to_float(record[7], 0.0),
                pressure=try_convert_to_float(record[8], 0.0),
                wind_speed=try_convert_to_float(record[10], 0.0),
                snow=try_convert_to_float(record[11], 0.0),
                rain=try_convert_to_float(record[12], 0.0))
